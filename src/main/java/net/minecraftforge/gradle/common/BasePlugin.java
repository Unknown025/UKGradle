...
//                addMavenRepo(proj, "forge", Constants.FORGE_MAVEN);
                addMavenRepo(proj, "Rainyville", Constants.RAINYVILLE_MAVEN);
    ...
    private void setVersionInfoJson() {
        ...
        getExtension().mcpJson = JsonFactory.GSON.fromJson(
                ...
                new TypeToken<Map<String, Map<String, int[]>>>() {
                }.getType());
    }
    ...
    public void afterEvaluate() {
        ...
        logger.lifecycle("#################################################");
        logger.lifecycle("         UKGradle {}          ", this.getVersionString());
        logger.lifecycle("  https://github.com/Unknown025/UKGradle  ");
        logger.lifecycle("#################################################");
        ...
        logger.lifecycle("    R4wk, ZeuX, IngisKahn, bspkrs, Unknown025    ");
        logger.lifecycle("   UNOFFICIAL VERSION: NOT SUPPORTED BY FORGE!   ");
        logger.lifecycle("#################################################");
        displayBanner = false;
    }
    ...
    private void makeObtainTasks() {
        ...
        Delete clearCache = makeTask("cleanCache", Delete.class);
        {
            ...
            clearCache.setDescription("Clears the ForgeGradle cache. DO NOT RUN THIS unless you want a fresh start, or the dev tells you to.");
        }
